            ...
            <div className="intro-wrap">
              ...
              <div className="intro-item">
                ...
                <div className="content">
                  <h3 className="title">Fairly Priced</h3>
                  <div className="text">
                    We believe in fair pricing, offering beautiful jewellery
                    without the extra cost. Get luxury that’s affordable.
                  </div>
                </div>
              </div>
              <div className="intro-item">
                ...
                <div className="content">
                  <h3 className="title">Top Quality</h3>
                  <div className="text">
                    Each piece is crafted to the highest standards, ensuring
                    lasting beauty and durability, made to shine for years to
                    come.
                  </div>
                </div>
              </div>
